...
#import "COImageCropperViewController.h"

#define SCALE_FRAME_Y 100.0f
#define BOUNDCE_DURATION 0.3f

@interface COImageCropperViewController ()
...
@implementation COImageCropperViewController
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(COImageCropperDelegate)]) {
